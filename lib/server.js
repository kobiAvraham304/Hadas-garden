...
function isTeacher(caller) { return /גננ/.test(String(caller?.employee?.job_title || '')); }
function canCreateContent(caller) { return isManager(caller) || isTeacher(caller); }
