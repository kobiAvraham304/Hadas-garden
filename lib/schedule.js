  ...
  for (const date of dates) {
    ...
    for (const classItem of activeClasses) {
      ...
      for (let slot = opening; slot < closing; slot += slotMinutes) {
        ...
        const expected = requiredStaffAt(settings, date, slot);
...
module.exports = { timeToMinutes, minutesToTime, overlaps, dateRange, weekdayOf, closingTimeForDate, requiredStaffAt, calculateWeeklyMinutes, validateWeek };
